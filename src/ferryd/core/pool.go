...
// addPackageInternal used by AddPackage for the main bulk of the work
func (p *Pool) addPackageInternal(db libdb.Database, pkg *libeopkg.Package, copyDisk bool) (*PoolEntry, error) {
...
func (p *Pool) AddPackage(db libdb.Database, pkg *libeopkg.Package, copy bool) (*PoolEntry, error) {
	return p.addPackageInternal(db, pkg, copy)
}
